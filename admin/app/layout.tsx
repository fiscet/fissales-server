...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    other: [
      { rel: 'android-chrome', url: '/images/favicons/android-chrome-192x192.png', sizes: '192x192' },
      { rel: 'android-chrome', url: '/images/favicons/android-chrome-512x512.png', sizes: '512x512' },
    ],
  },
