...
export const salesAgent = new Agent({
  name: "sales-agent",
  description: "Master sales professional trained in Zig Ziglar methodology who helps customers achieve their winter sports dreams while closing sales with genuine care and expertise",
