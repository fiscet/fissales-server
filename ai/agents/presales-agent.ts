...
export const presalesAgent = new Agent({
  name: "presales-agent",
  description: "Pre-sales agent that understands customer needs, fetches relevant products using RAG tools, and prepares comprehensive information for the sales agent",
  instructions: async ({ runtimeContext }) => {
    ...
    const customerRequirements = String(runtimeContext?.get("customerRequirements") || "");
